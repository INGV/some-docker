#!/root/miniconda3/envs/gpd_conda_tf1/bin/python
...
if __name__ == "__main__":
    ...
    print("%r - %s" % (args.g, type(args.g)))
    print("%r - %s" % (args.a, type(args.a)))
    print("%r - %s" % (args.b, type(args.b)))
    print("%r - %s" % (args.c, type(args.c)))
    print("%r - %s" % (args.d, type(args.d)))
    print("%r - %s" % (args.e, type(args.e)))
    print("%r - %s" % (args.f, type(args.f)))
